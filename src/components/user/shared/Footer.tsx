        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-slate-400">
              Quick<span className="text-slate-300">Loan</span>
            </h3>
            <p className="text-slate-300 mb-4 max-w-xs">
              Providing quick and easy financial solutions to meet your
              personal, business, and agricultural needs.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-slate-300 hover:text-slate-300">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-slate-300">
                  123 Finance Street, Money City, MC 12345
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-slate-300">info@QuickLoan.com</span>
              </li>
            </ul>
          </div>
        </div>

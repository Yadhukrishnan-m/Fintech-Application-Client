...
export default function UserLoanListCard({
  ...
  return (
    <div className="relative bg-gradient-to-br from-teal-500 to-teal-800 text-white p-6 rounded-xl shadow-lg w-full sm:w-[80%] md:w-[60%] lg:w-[30%] mb-6 transition-transform transform hover:scale-[1.02] hover:shadow-xl">
      ...
      <div className="mt-4 flex flex-col sm:flex-row justify-between items-center">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-white text-teal-700 px-4 py-2 mt-4 sm:mt-0 rounded-md font-semibold transition hover:bg-teal-600 hover:text-white"
        >
          View Details

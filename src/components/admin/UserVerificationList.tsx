...
const links = [
  {
    label: "Verify User",
    to: (row: User) => `/admin/user-verification/${row._id}`,
  },
];

function UserVerificationList() {
  ...
  const fetchUsers = useCallback(async () => {
    setLoading(true);
    try {
    const response = await userManagementService.getUnverifiedUsers({
      currentPage,
      searchQuery,
      sortBy,
      filter,
  ...
  // Use debouncedSearch for search input
